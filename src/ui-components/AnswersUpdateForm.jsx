...
export default function AnswersUpdateForm(props) {
  ...
  const [answersRecord, setAnswersRecord] = React.useState(answersModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Answers, idProp)
        : answersModelProp;
      setAnswersRecord(record);
    };
    queryData();
  }, [idProp, answersModelProp]);
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || answersModelProp)}
